...
import { blockchain_backend } from '../../../declarations/blockchain_backend/index'
...
async function endGame(word){
    ...
    const userNew=await blockchain_backend.upgradeScore(user.name,user.pass,user.email,parseInt(user.wins),parseInt(user.loses)+1)
    setUser(userNew)
    ...
    if(word===wordNew){
        ...
        const userNew=await blockchain_backend.upgradeScore(user.name,user.pass,user.email,parseInt(user.wins)+1,parseInt(user.loses))
        setUser(userNew)
